...
import uk.ac.city.slamanager.rest.api.everest.entities.EventParameter;
import uk.ac.city.slamanager.rest.api.everest.entities.TemplateDefined;
import uk.ac.city.slamanager.rest.api.everest.repositories.EventRepository;
import uk.ac.city.slamanager.rest.api.everest.repositories.TemplateDefinedRepository;
import uk.ac.city.slamanager.rest.api.everest.repositories.TemplateRepository;
import uk.ac.city.slamanager.rest.api.entities.*;
import uk.ac.city.slamanager.rest.api.repositories.*;
...
public class ProjectRESTController {
    ...
    public ResponseEntity<?> createSLO(@PathVariable Integer uid, @PathVariable Integer pid, @RequestBody SloRequest sloRequest) {
        ...
        try {
            ...
            File fileTemplate = File.createTempFile("slamanager-slo-template-", ".vm");
            ...
            final File sloXml = File.createTempFile("slamanager-slo-ecassertion-", ".xml");
           ...
           Thread.sleep(6000);
            ...
            final ProcessBuilder slamanagerClientAdd = new ProcessBuilder("java", "-jar", "/home/abfc149/ToreadorSLAClient2.jar", "add", sloXml.getCanonicalPath());

            Object[] cmd = (Object[]) slamanagerClientAdd.command().toArray();
            ...
            Process process = slamanagerClientAdd.start();
            ...
            if (result == 0) {
                ...
                final ProcessBuilder slamanagerClientSubmit = new ProcessBuilder("java", "-jar", "/home/abfc149/ToreadorSLAClient2.jar", "submit", cid);

                Process p = slamanagerClientSubmit.start();
                cmd = (Object[]) slamanagerClientSubmit.command().toArray();
    ...
    public ResponseEntity<List<uk.ac.city.slamanager.rest.api.everest.entities.Template>> getAllTemplates() {
