...
@EnableJpaRepositories(basePackages = { "uk.ac.city.slamanager.rest.api.everest.repositories" },
...
public class EverestDataSourceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean everestEntityManagerFactory()
		...
		factory.setPackagesToScan(new String[] { "uk.ac.city.slamanager.rest.api.everest.entities" });
